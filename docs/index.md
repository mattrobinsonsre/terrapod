...
| [Terraform provider](terraform-provider.md) | `terraform-provider-terrapod` — manage Terrapod itself as code (workspaces, variables, roles, VCS connections, agent pools, run tasks, catalog, execution hooks, …) via 25 `terrapod_*` resources + 9 data sources; served per-instance and GPG-signed |
