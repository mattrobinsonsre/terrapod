...
| **Remote State Management** | Versioned state storage with locking, rollback, Fernet encryption at rest |
...
| **Variables & Secrets** | Per-workspace env and Terraform variables; Fernet-encrypted sensitive values; variable sets |
...
| **Agent Pools** | Named groups of remote runner listeners with certificate-based auth |
