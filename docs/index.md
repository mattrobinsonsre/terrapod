...
| [FAQ](faq.md) | Straight answers to the common buyer questions (free? OpenTofu? Terragrunt? air-gapped? production-ready? do I really need Kubernetes? can mixed-tool teams share one install? monorepo / dedicated / mixed repos? vs Terrakube/Atlantis/Digger?) |
