...
class TestCollectGatesOrder:
    """Gates come back in the order `run_service.blocked_by` evaluates them.
...
class TestTheAIPolicyGateAppearsInTheComment:
    ...
    gates and `run_service.blocked_by` checks four. A run this gate was
...
class TestApplyPromptRespectsGates:
    ...
    The gate holds a run whose mandatory check failed, so
