...
multipart upload and Azure never commits its block list, so both were already
all-or-nothing. The filesystem backend wrote straight to the key, and the GCS
backend ended its resumable upload normally when the stream failed, which
finalized whatever had been sent.
"""
