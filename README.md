...
| [Cost Estimation](docs/cost-estimation.md) | Monthly cost of managed infrastructure (per-plan delta + per-workspace state total); native OpenInfraQuote-port engine (data), plus an optional AI layer that estimates unpriced resources + advisories + a grounded cost chat |
