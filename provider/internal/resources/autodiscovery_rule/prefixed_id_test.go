...
//
// On main this helper lives in engine_version_test.go, which belongs to the
// engine-version work (#1559) that this line does not carry. It is defined
// here rather than backporting that file, so the fix brings nothing with it
